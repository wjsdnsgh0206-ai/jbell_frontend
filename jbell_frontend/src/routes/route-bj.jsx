...
//FAQ 페이지
const FAQListPage = lazy(() => import("@/pages/user/FAQListPage"));
const FAQDetailPage = lazy(() => import("@/page/user/FAQDetailPage"));

//QnA 페이지
const QnAListPage = lazy(() => import("@/pages/user/QnAListPage"));
const QnADetailPage = lazy(() => import("@/pages/user/QnADetailPage"));
