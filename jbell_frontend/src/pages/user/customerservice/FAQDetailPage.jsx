...
const FAQDetailPage = () => {
  ...
  const faqData = [
    ...
    { id: 5, question: "사람은 어떻게 태어나는 건가요? (5)", answer: "답변 내용...", date: "2023.10.05", modifiedDate: "2023.10.05", tag: "질문 유형" },
    { id: 6, question: "비밀번호를 변경하고 싶어요. (6)", answer: "답변 내용...", date: "2023.10.06", modifiedDate: "2023.10.06", tag: "계정 관리" },
    { id: 7, question: "환불 규정이 어떻게 되나요? (7)", answer: "답변 내용...", date: "2023.10.07", modifiedDate: "2023.10.07", tag: "결제/환불" },
    { id: 8, question: "서비스 이용 시간이 궁금해요. (8)", answer: "답변 내용...", date: "2023.10.08", modifiedDate: "2023.10.08", tag: "이용 문의" },
