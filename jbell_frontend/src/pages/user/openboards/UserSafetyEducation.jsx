...
const UserSafetyEducation = () => {
  ...
  // 브레드크럼(네비게이션 경로) 데이터 설정
  const breadcrumbItems = [
    { label: "홈", path: "/", hasIcon: true },
    { label: "열린마당", path: "/userSafetyEducation", hasIcon: false },
    { label: "시민안전교육", path: "/userSafetyEducation", hasIcon: false },
  ];

  return (
    /* 레이아웃 설정: 
       - w-full: 전체 너비 사용
       - px-5: 모바일 기기에서 좌우 여백 확보
       - md:px-0: 데스크탑(중간 사이즈 이상)에서는 부모 컨테이너에 맞춰 여백 제거
    */
