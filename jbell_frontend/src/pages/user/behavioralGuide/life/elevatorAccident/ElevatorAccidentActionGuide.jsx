...
import { elevatorAccidentData } from './data';

const ElevatorAccidentActionGuide = () => {
  // 데이터 구조 분해 할당
  const { meta, contents } = elevatorAccidentData;
...
export default ElevatorAccidentActionGuide;