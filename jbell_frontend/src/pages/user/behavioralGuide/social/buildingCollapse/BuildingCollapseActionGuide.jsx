...
import { buildingCollapseData } from './data';

const BuildingCollapseActionGuide = () => {
  // 데이터 구조 분해 할당
  const { meta, contents } = buildingCollapseData;
...
export default BuildingCollapseActionGuide;