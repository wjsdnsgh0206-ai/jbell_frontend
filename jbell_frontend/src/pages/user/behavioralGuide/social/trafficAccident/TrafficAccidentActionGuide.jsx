...
// [핵심] 교통사고 데이터 파일 import
import { trafficAccidentData } from './data';

const TrafficAccidentActionGuide = () => {
  // 데이터 구조 분해 할당
  const { meta, contents } = trafficAccidentData;
...
export default TrafficAccidentActionGuide;