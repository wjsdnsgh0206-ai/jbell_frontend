...
const UserMap = () => {
  return (
    <div className="flex flex-1 relative overflow-hidden min-h-[600px]">
      ...
      <main className="flex-1 relative bg-slate-200">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1608889175013-5f7a5a7f3c4b?fit=crop&w=1200&h=800')`
          }}
        >
