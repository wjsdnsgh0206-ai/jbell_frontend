          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
              ...
              <div className="space-y-4">
                {[1, 2, 3, 4, 5].map((item) => (
                  <div
                    key={item}
                    className="flex items-center justify-between group cursor-pointer border-b border-gray-50 pb-3 last:border-0 last:pb-0"
                  >
                    <div className="flex items-center gap-4 overflow-hidden">
                      <span className="shrink-0 w-12 text-center py-1 rounded text-[11px] font-bold border border-blue-200 text-blue-500 bg-blue-50">
                        태풍
                      </span>
                    ...
                    <span className="shrink-0 text-xs text-gray-400 tabular-nums ml-4">
                      2025.12.05
                    </span>
                  </div>
                ))}
            ...
            <div className="w-full lg:w-[400px] flex flex-col gap-4">
              <div className="flex-1 bg-gradient-to-br from-[#1e3a8a] to-[#3b82f6] text-white rounded-2xl p-6 shadow-lg relative overflow-hidden">
                ...
                <div className="absolute right-[-10px] bottom-[-10px] text-[100px] opacity-20">
                  🌙
                </div>
              </div>
              ...
              <div className="space-y-5">
                {[1, 2, 3, 4, 5].map((i) => (
                  ...
                  >
                    ...
                    <span className="shrink-0 text-sm text-gray-400 tabular-nums ml-4">
                      12.05
                    </span>
                  </div>
                ))}
