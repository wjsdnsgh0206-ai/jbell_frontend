...
const Wildfire = () => {
  ...
  const mapTabs = [
    ...
    { id: "실시간화점", label: "실시간 화점정보" },
    { id: "대형산불주의보", label: "대형산불 주의보" },
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border min-h-[550px]">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-bold text-gray-800">실시간 산불정보</h3>
              <span className="text-xs px-2 py-0.5 bg-orange-50 border border-orange-100 rounded text-orange-600 font-medium">
                건조주의보 발령 중
              </span>
            </div>
          ...
          <div className="relative h-[450px] bg-slate-50 rounded-xl border overflow-hidden">
            ...
            {/* 정보 요약 창 (산불/건조도 특화) */}
            <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm p-4 rounded-xl border border-gray-100 shadow-md z-10 min-w-[200px]">
              <div className="space-y-3">
                <p className="text-[11px] font-bold text-gray-400 uppercase tracking-tight">Forest Fire Index</p>
                <div className="space-y-2">
                  <div className="flex flex-col">
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-xs font-bold text-gray-600">오늘의 위험지수</span>
                      <span className="text-xs font-black text-orange-600">65 (높음)</span>
                    </div>
                    <div className="w-full bg-gray-200 h-1.5 rounded-full overflow-hidden">
                      <div className="bg-orange-500 h-full w-[65%]" />
                    </div>
                  </div>
                  <div className="flex items-center gap-2 py-1 border-t border-gray-100 mt-2">
                    <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
                    <span className="text-xs font-bold text-gray-700">최근 24시간 내 화점: 0건</span>
                  </div>
                </div>
              </div>
            </div>
