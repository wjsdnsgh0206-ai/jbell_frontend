...
import { electricityGasAccidentData } from './data';

const ElectricityGasAccidentActionGuide = () => {
  // 데이터 구조 분해 할당
  const { meta, contents } = electricityGasAccidentData;
...
export default ElectricityGasAccidentActionGuide;