...
import { roadTunnelAccidentData } from './roadTunnelAccident/data';

const RoadTunnelAccidentBehaviorMethod = () => {
  // 데이터 구조 분해 할당
  const { meta, contents } = roadTunnelAccidentData;
...
export default RoadTunnelAccidentBehaviorMethod;