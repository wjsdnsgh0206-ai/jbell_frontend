...
const DisasterSummarySection = () => {
  ...
  return (
    <section className="w-[735px] h-[416px] top-[266px] left-[50px] absolute rounded-xl border border-solid border-gray-200 bg-slate-50 flex flex-col items-center justify-center">
      {/* 지도 배경 대용 아이콘 */}
      ...
      <div className="absolute bottom-6 right-6 bg-white p-3 rounded-lg border border-gray-200 shadow-sm flex flex-col gap-2">
        <div className="flex items-center gap-2 text-xs font-medium">
          <div className="w-3 h-3 rounded-full bg-[#0B78CB]" /> 위급(재난)
        </div>
        <div className="flex items-center gap-2 text-xs font-medium">
          <div className="w-3 h-3 rounded-full bg-[#DE3412]" /> 주의(특보)
        </div>
      </div>
    </section>
  );
