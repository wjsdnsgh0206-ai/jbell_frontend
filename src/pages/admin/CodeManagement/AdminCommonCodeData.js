...
export const AdminCommonCodeData = [
  ...
  { id: 4, groupCode: 'Category-3', groupName: '카테고리3', detailCode: 'ABCD-3_2', detailName: '대피소 분류2', desc: '지역별 행정구역 대피소 분류 코드번호2', date: '2025-05-20 06:00', order: 2, visible: false },
  ...
  { id: 8, groupCode: 'Category-4', groupName: '카테고리4', detailCode: 'ABCD-4_2', detailName: '공지사항', desc: '공지사항 고유 코드번호', date: '2025-05-20 06:00', order: 2, visible: true },
  {id: 9, groupCode: 'Category-4', groupName: '카테고리4', detailCode: 'ABCD-4_3', detailName: '고객센터', desc: '고객센터 고유 코드번호', date: '2025-05-20 06:00', order: 3, visible: true },
  {id: 10, groupCode: 'Category-4', groupName: '카테고리4', detailCode: 'ABCD-4_3', detailName: '고객센터', desc: '고객센터 고유 코드번호', date: '2025-05-20 06:00', order: 3, visible: true },
  {id: 11, groupCode: 'Category-4', groupName: '카테고리4', detailCode: 'ABCD-4_3', detailName: '고객센터', desc: '고객센터 고유 코드번호', date: '2025-05-20 06:00', order: 3, visible: true },
];