...
import { BehaviorMethodData } from './BehaviorMethodData';
...
const BehaviorMethodList = () => {
  ...
  // ==================================================================================
  const [guides, setGuides] = useState(BehaviorMethodData); // 전체 데이터 @@
...
``
  ...
  const goDetail = useCallback((id) => {
    navigate(`/admin/contents/behaviorMethodDetail/${id}`);
  }, [navigate]);
