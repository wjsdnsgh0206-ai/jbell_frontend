      ...
      <div className="bg-white rounded-2xl p-4 lg:p-5 border border-gray-100 flex-1 flex flex-col min-h-0">
        ...
        <div className="flex justify-between items-center mb-4 flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            {damData.length > 0 && (
              <span
                className={`rounded-xl font-bold text-center text-[10px] px-2.5 py-1 md:text-detail-s md:px-4 md:py-1.5 md:w-[80px] transition-colors ${
                  isDangerous
        ...
        <div className="relative flex-1 bg-slate-50 rounded-2xl border border-gray-100 overflow-hidden min-h-[300px] md:min-h-[400px] lg:min-h-0">
              ...
              <div className="flex flex-col gap-4 max-w-4xl">
                <div className="bg-white/95 p-3 rounded-xl shadow-md border border-blue-200 self-start backdrop-blur-md">
                  <p className="text-detail-s-bold text-blue-700 flex items-center gap-2">
                    <span className="animate-pulse">🌊</span> 전북 및 전국 주요
                    댐 현황
                  </p>
                </div>
                        ...
                        <div className="flex justify-between items-start mb-3">
                          <div className="flex flex-col">
                            <div className="flex items-center gap-1.5">
                              ...
                              <h4 className="text-body-m-bold text-gray-900">
                                {dam.name}
                              </h4>
                            </div>
                          ...
                          <div className="text-right">
                            <span
                              className={`text-[11px] px-2 py-1 rounded-lg font-bold inline-block ${
                                parseFloat(dam.storageRate) >= 90
                                  ? "bg-red-100 text-red-600"
          ...
          {activeTab === "재난안전시설" && (
            ...
            >
              <FacilityCheckGroup
                items={floodItems} // 각 파일의 아이템 변수명으로 변경 (typhoonItems 등)
