  ...
  return (
    <header className="flex flex-col w-full relative z-50 bg-white shadow-sm">
      ...
      <div className="flex w-full max-w-screen-xl mx-auto items-center justify-between py-4 px-4 sm:px-6 xl:px-8">
        ...
        {/* 관리자 페이지 이동(임시) */}
        { user?.userGrade === 'ADMIN' && (<div className="text-body-l-bold text-graygray-70 hover:text-secondary-50 transition-colors px-4 py-1 border border-graygray-50 rounded-lg">
