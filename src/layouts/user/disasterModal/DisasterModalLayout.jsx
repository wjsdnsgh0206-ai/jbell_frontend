...
const DisasterModalLayout = () => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col md:items-center md:justify-center bg-black/60 md:p-5 overflow-y-auto lg:overflow-hidden">
      <div
        className="custom-scrollbar hidden md:block absolute inset-0 -z-10"
        onClick={() => navigate("/")}
      />
      ...
      <div className="relative w-full max-w-[1750px] h-fit md:h-[92vh] bg-[var(--graygray-0)] md:rounded-3xl flex flex-col lg:flex-row shadow-2xl overflow-visible lg:overflow-hidden">
        ...
        <aside className="hidden lg:flex w-[280px] bg-[var(--graygray-90)] text-[var(--graygray-0)] flex-col flex-shrink-0">
          {/* aside 로고 영역  */}
          <div className="px-5 pt-5 flex justify-center align-center items-center border-b border-white/5">
            <img
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[var(--graygray-5)] overflow-visible lg:overflow-hidden">
          <header className="sticky top-0 lg:relative px-5 py-4 border-b border-[var(--graygray-20)] bg-[var(--graygray-0)] flex justify-between items-center z-50 flex-shrink-0">
            <div className="flex items-center gap-4">
              <button
                onClick={() => setIsMenuOpen(true)}
                className="lg:hidden p-2 hover:bg-[var(--graygray-10)] rounded-xl"
              >
                <svg
                  className="w-6 h-6 text-[var(--graygray-90)]"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
              ...
              <h2 className="text-body-m-bold md:text-title-xl text-[var(--graygray-90)]">
                {currentTitle}
              </h2>
            </div>
            <button
              className="p-2 hover:bg-[var(--graygray-10)] rounded-full"
              onClick={() => navigate("/")}
            >
          ...
          <div className="flex-1 overflow-visible lg:overflow-hidden p-4 md:p-8 lg:h-full min-h-0">
            <div className="flex flex-col lg:flex-row gap-6 lg:h-full">
              <main className="w-full lg:flex-[1.6] flex flex-col min-h-0 order-1 lg:h-full">
                <Suspense
                  fallback={
                    <div className="text-body-m text-[var(--graygray-50)]">
                      로딩 중...
                    </div>
                  }
                >
                  ...
                  <div
                    ...
                    ${
                      isWeatherOpen
                        ...
                        : "max-h-0 lg:max-h-[300px] opacity-0 lg:opacity-100"
                    } 
