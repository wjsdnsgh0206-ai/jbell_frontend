...
export const disasterApi = {
  ...
  createDisaster: async (data) => {
    const response = await api.post(
      "/disaster/dashboard/disasterMessages",
      data,
    );
    return response.data;
  },
  ...
  deleteDisasters: async (sns) => {
    const response = await api.post(
      "/disaster/dashboard/disasterMessages/delete",
      sns,
    );
    return response.data;
  },
  ...
  getWeatherDetail: async (key) => {
    const response = await api.get(
      `/disaster/dashboard/weatherWarnings/${key}`,
    );
    return response.data;
  },
  ...
  createWeather: async (data) => {
    const response = await api.post(
      "/disaster/dashboard/weatherWarnings",
      data,
    );
    return response.data;
  },
  ...
  updateWeatherVisibility: async (ids, visibleYn) => {
    const response = await api.post(
      "/disaster/dashboard/weatherWarnings/visibility",
      {
  ...
  deleteWeatherWarnings: async (keys) => {
    const response = await api.post(
      "/disaster/dashboard/weatherWarnings/delete",
      keys,
    );
    return response.data;
  },
...
export const codeService = {
  ...
  getCodeItem: async (groupId, itemId) => {
    const response = await api.get(
      `/common/code/groups/${groupId}/items/${itemId}`,
    );
    return response.data;
  },
  addItem: async (groupId, data) => {
    const response = await api.post(
      `/common/code/groups/${groupId}/items`,
      data,
    );
    return response.data;
  },
...
----------------------------- */
  ...
  getLandSlideWarning: (params = {}) => {
    ...
    return axios.get("/api/disaster/fetch/landslide-list", {
